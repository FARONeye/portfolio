...
export default function AboutSection() {
  ...
  // ✅ Timer géré hors useEffect (sinon ESLint chez toi crie)
        ...
        >
          ...
          <div className="space-y-6 text-lg text-[#b3b3b3] leading-relaxed text-pretty">
            <p>
              ...
              Life is an open-world game, and I&apos;m grinding every day to level
              up my skills.
            </p>
            ...
            >
                ...
                {isModelReady && (
                  <div className="absolute inset-0 z-20 pointer-events-none">
                    {GEAR.map((item, i) => (
                      ...
                      >
                        <div
                          className={`w-10 h-10 md:w-14 md:h-14 backdrop-blur-md rounded-lg flex items-center justify-center transition-all duration-300 border-2 hover:scale-110 ${getRarityColor(
                            item.rarity
                          )} ${
                            selectedGear?.id === item.id
                              ? "scale-110 shadow-[0_0_20px_currentColor] bg-white/20"
              ...
              <div className="w-full md:w-1/4 bg-[#0F0F11]/95 backdrop-blur-md border-t md:border-t-0 md:border-r border-white/10 p-4 md:p-6 flex flex-col gap-4 md:gap-6 order-2 md:order-1 z-20 shadow-2xl overflow-y-auto custom-scrollbar flex-1 md:flex-none">
                ...
                <div className="space-y-3 md:space-y-4 bg-white/5 p-4 md:p-5 rounded-xl border border-white/5">
                  ...
                  <AttributeRow
                    icon={<Brain size={16} className="text-[#9B1C31]" />}
                    label="Mindset"
                    value="Kaizen"
                  />
                  <AttributeRow
                  ...
                  <div className="flex flex-col gap-2 py-1">
                    <div className="flex items-center gap-3 text-zinc-400 mb-1">
                      ...
                      <span className="text-xs md:text-sm">Languages</span>
                    </div>
                    <div className="grid grid-cols-2 gap-2 pl-7">
                      <div className="bg-white/5 rounded p-2 flex flex-col items-center justify-center border border-white/5 hover:border-white/20 transition-colors">
                        <span className="text-[9px] text-zinc-500 uppercase tracking-wider mb-1">
                          Fluent
                        </span>
                      ...
                      <div className="bg-white/5 rounded p-2 flex flex-col items-center justify-center border border-white/5 border-dashed">
                        ...
                        <div className="flex flex-wrap justify-center gap-1">
                          {["ES", "VN", "CN", "JP", "KR"].map((l) => (
                            <span
                              key={l}
                              className="text-[9px] bg-white/10 px-1 rounded text-zinc-400"
                            >
                              {l}
                            </span>
                          ))}
                  ...
                  />
                  <AttributeRow
                    icon={<Fingerprint size={16} className="text-cyan-400" />}
                    label="Signature"
                    value="Immersive UI"
                  />
                  <AttributeRow
              ...
              <div
                className={`w-full md:w-1/4 bg-[#0F0F11] md:bg-[#0F0F11]/95 backdrop-blur-md border-t md:border-t-0 md:border-l border-white/10 p-6 flex flex-col z-40 shadow-2xl absolute inset-x-0 bottom-0 top-auto h-[60vh] md:h-auto md:inset-auto md:relative transition-transform duration-300 ease-out rounded-t-3xl md:rounded-none order-3 md:order-3 ${
                  selectedGear ? "translate-y-0" : "translate-y-[110%] md:translate-y-0"
                      ...
                      <div>
                        <div
                          className={`text-xs font-bold tracking-widest uppercase mb-2 inline-block px-2 py-0.5 rounded ${
                            selectedGear.rarity === "legendary"
                              ? "text-yellow-400 bg-yellow-400/10"
                              : selectedGear.rarity === "epic"

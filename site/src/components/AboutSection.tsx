...
export default function AboutSection() {
  ...
  // --- SCROLL LOCK RENFORCÉ (HTML + BODY) ---
  useEffect(() => {
    if (isExpanded) {
      // Bloque tout : html et body
